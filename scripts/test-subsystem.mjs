...
export const SUBSYSTEM_TEST_TARGETS = {
  ...
  "data-model": {
    ...
    patterns: [
      ...
      /^src\/lib\/structured-json\.test\.ts$/,
      /^src\/test\//,
  ...
  editor: {
    ...
    patterns: [
      ...
      /^e2e\/auth\/authenticated-nested-routes\.spec\.ts$/,
      /^e2e\/editor\/(?:block-id-preservation|document-editor-profile|document-table-autosave)\.spec\.ts$/,
      /^e2e\/ui-matrix\/document-metadata-history-ui\.spec\.ts$/,
  ...
  presentation: {
    ...
    patterns: [
      ...
      /^e2e\/presentation\/(?:focus-and-mobile-controls-regression|overlap-selection-regression|pointer-interactions|present-export|presentation-controls|slide-asset-upload|slide-delete-persistence|slides-conflict-recovery|slides-layout-screenshots|slides-smoke|touch-controls)\.spec\.ts$/,
  ...
  security: {
    ...
    patterns: [
      ...
      /^e2e\/ui-matrix\/(?:account-lifecycle-ui|auth-public-ui|document-metadata-history-ui|public-render-ui|workspace-lifecycle-ui)\.spec\.ts$/,
    ],
  },
  system: {
    description:
    ...
    patterns: [
      ...
      /^src\/components\/header-gate\.test\.tsx$/,
      /^src\/components\/mobile-nav-menu\.test\.tsx$/,
      /^src\/components\/mobile-viewport-sync\.test\.tsx$/,
      /^src\/components\/sign-out-button\.test\.tsx$/,
      /^src\/components\/theme-mode-button\.test\.tsx$/,
