...
export const SUBSYSTEM_TEST_TARGETS = {
  ...
  editor: {
    ...
    patterns: [
      ...
      /^e2e\/editor\/(?:block-id-preservation|document-editor-profile)\.spec\.ts$/,
  ...
  presentation: {
    ...
    patterns: [
      ...
      /^e2e\/presentation\/(?:present-export|slide-asset-upload|slides-layout-screenshots|slides-smoke)\.spec\.ts$/,
      /^e2e\/visual\/screenshot-regression\.spec\.ts$/,
