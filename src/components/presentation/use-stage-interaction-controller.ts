...
import type { StageGuide } from "@/lib/presentation/stage-guides";
import type { SelectionFrame } from "@/lib/presentation/selection-geometry";
...
import type { KeyboardConnectorModePresentation } from "./stage-keyboard-interactions";
...
export type StageInteractionAction =
  ...
  | {
      ...
      value: SetStateAction<KeyboardConnectorModePresentation | null>;
    }
