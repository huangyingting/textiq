...
/**
 * Renderer for a single resolved render node from the presentation render tree.
 *
...
import { visualChannelColorWithDefaults } from "@/lib/presentation/visual-channel-colors";
import type {
  TextContent,
  TextRun,
  TableContent,
...
function ConnectorNodeContent({
  ...
  const startMarkerId = `connector-start-arrow-presentation-${nodeId}`;
  const endMarkerId = `connector-end-arrow-presentation-${nodeId}`;
