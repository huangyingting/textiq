...
import type { PptxTextOp } from "../pptx-export-adapter";
...
/**
 * Converts a presentation `TextContent` into PptxGenJS text runs.
...
export function applyPptxTextOp(slide: PptxSlide, op: PptxTextOp): void {
