...
import { safeParseDeckV7, validateDeckChromeConfig } from "./validation";
import {
  buildDeckV7,
  buildLayoutBox,
  buildSlideV7,
...
test("safeParseDeckV7 reports deeply malformed current v7 authoring contracts", () => {
...
test("safeParseDeckV7 catches unexpected validator exceptions", () => {
  ...
  const result = safeParseDeckV7(throwing);
  assert.equal(result.success, false);
