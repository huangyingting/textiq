...
| [legacy-retirement-plan.md](legacy-retirement-plan.md)                   | Plan         | Remaining P0 work to remove dynamic legacy references and delete the legacy v6 presentation surface.                          |
