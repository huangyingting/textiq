...
| Document                                                                             | Type         | Scope                                                                                                                                                                                                                            |
| ------------------------------------------------------------------------------------ | ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [canonical-deck-contract.md](canonical-deck-contract.md)                             | Architecture | Canonical persisted `Deck` contract boundary, `safeParseDeck` as single validation entry, active v6 violations as migration risks, deck-kernel retirement targets, and staged migration criteria including data migration gates. |
