...
| Document                                                                             | Type         | Scope                                                                                                                                                                                                                                                                                                                        |
| ------------------------------------------------------------------------------------ | ------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [canonical-deck-contract.md](canonical-deck-contract.md)                             | Architecture | Canonical persisted `Deck` contract boundary, `safeParseDeck` as single validation entry, active v6 violations as migration risks, complete deck-kernel import inventory (36 statements / 17 files / 8 families), diff/metrics dependency sequencing, topological staged migration (B3–B8-e) including data migration gates. |
