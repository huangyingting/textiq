...
export const UI_MATRIX_SPEC_INVENTORY = [
  ...
  },
  {
    ...
    coverage:
      "Seeded dashboard search/filter/sort/actions, mobile navigation, document hydration/history/chrome/share/export/autosave/viewer access, and slide-editor controls, persistence, race safety, history, focus, and responsive dock behavior.",
    runMode: "advisory-ci",
    prerequisites: ["E2E_PROFILE=1", "npm run db:seed:e2e"],
    roles: ["seeded owner", "seeded viewer", "anonymous public share"],
    devices: ["Desktop Chrome", "390x844 mobile", "834x1112 tablet"],
    ciStatus: "advisory deterministic E2E workflow",
    sourceRefs: ["e2e/README.md", "docs/editor/document-editor.md"],
    ...
    tests: [
      {
        test: "dashboard search, filters, sorting, favorites, and safe actions are deterministic",
        surface:
          "dashboard search, sort, favorite/tag filters, and cancel-safe actions",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      },
      {
        test: "dashboard search, history, and template picker controls are reachable",
        surface:
          "dashboard search, browser history, and keyboard template picker",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "mobile authenticated navigation drawer reaches workspace and brand routes",
        surface: "mobile authenticated navigation drawer and route transitions",
      ...
      {
        test: "opens the seeded document editor with deterministic content @required-profile",
        surface: "document body hydration and statistics",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "required",
      ...
      {
        test: "document editor survives reload and browser back-forward navigation",
        surface: "document reload and browser history restoration",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      },
      {
        test: "editor chrome exposes non-mutating panels and share metadata",
        surface:
          "page guides, style, share metadata, and version-history panels",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "editor import and export controls expose non-destructive menu states",
        surface: "document import focus and export menu state",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "slide editor opens, exposes controls and insert panels, then closes cleanly",
        surface: "slide editor shell, notes, shortcuts, insert menu, and close",
      ...
      {
        test: "slide rail duplicate, delete, and reorder actions mutate deck state and persist after reload",
        surface: "slide rail mutation, autosave, and reload persistence",
        viewport: "1280x900 desktop",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "rapid slide edit and delete cannot race Save now or regeneration into stale rollback",
        surface: "slide edit/delete/save/regeneration race safety",
        viewport: "1280x900 desktop",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "deckpresentation create-edit-save-reopen-export-share roundtrip stays deterministic",
        surface: "deck create/edit/save/reopen/export/public-share round trip",
        viewport: "1280x900 desktop",
      ...
      {
        test: "slide editor undo and redo keep deck state, autosave status, and focus coherent",
        surface: "slide history, autosave, and focus restoration",
        viewport: "1280x900 desktop",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "context toolbar Escape restores focus to the selected stage target",
        surface: "context-toolbar Escape focus restoration",
        viewport: "1280x900 desktop",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      },
      {
        test: "slide editor bottom dock stays compact and keyboard reachable across viewports",
        surface:
          "responsive slide bottom dock geometry and keyboard reachability",
        viewport: "390x844 mobile, 834x1112 tablet, 1280x900 desktop",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
        status: "automated",
      ...
      {
        test: "viewer can open the seeded document in read-only mode without owner controls",
        surface: "read-only viewer document and owner-control suppression",
        viewport: "Desktop Chrome",
        auth: "seeded viewer",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "editor autosave status live region is present and reports a known save state",
        surface: "document autosave status live region",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "dashboard sort by date created changes the sort URL param and preserves all documents",
        surface: "dashboard created-date sort URL and result preservation",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "share dialog exposes copy and regenerate link controls alongside share metadata",
        surface: "document share-link copy, rotation, and metadata",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "mobile editor chrome keeps key slide and collaboration actions reachable",
        surface: "mobile document editor action reachability and export close",
        viewport: "390x844 mobile",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
  ...
  },
  {
    ...
    tests: [
      {
        test: "base editor layout (desktop) @required-profile",
        surface: "desktop slide-editor base layout",
      ...
      {
        test: "rail hidden (desktop)",
        surface: "desktop filmstrip toggle and hidden-rail layout",
        viewport: "1280x800 desktop",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "notes expanded (desktop)",
        surface: "desktop speaker-notes expansion layout",
        viewport: "1280x800 desktop",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "right panel open with selection (desktop) @required-profile",
        surface: "desktop selected-title geometry and Text inspector",
        viewport: "1280x800 desktop",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "required",
      ...
      {
        test: "base editor layout (tablet) @required-profile",
        surface: "tablet slide-editor base layout",
        viewport: "834x1112 tablet",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "required",
      ...
      {
        test: "rail hidden (tablet)",
        surface: "tablet filmstrip toggle and hidden-rail layout",
        viewport: "834x1112 tablet",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "notes expanded (tablet)",
        surface: "tablet speaker-notes expansion layout",
        viewport: "834x1112 tablet",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "right panel open with selection (tablet) @required-profile",
        surface:
          "tablet selected-title geometry, toolbar separation, and Text inspector",
        viewport: "834x1112 tablet",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "required",
      ...
      {
        test: "base editor layout (mobile) @required-profile",
        surface: "mobile slide-editor base layout",
        viewport: "390x844 mobile",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "required",
      ...
      {
        test: "rail hidden (mobile)",
        surface: "mobile filmstrip toggle and hidden-rail layout",
        viewport: "390x844 mobile",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "notes expanded (mobile)",
        surface: "mobile speaker-notes expansion layout",
        viewport: "390x844 mobile",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "right panel open with selection (mobile) @required-profile",
        surface:
          "mobile selected-title geometry, toolbar separation, and Text inspector",
        viewport: "390x844 mobile",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "required",
  ...
  },
  {
    ...
    tests: [
      {
        test: "authenticated user can navigate to the Slides editor",
        surface: "document-to-slides navigation and canonical editor route",
        viewport: "Desktop Chrome",
        auth: "seeded owner or optional external owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
        status: "automated",
      },
      {
        test: "edit a slide title, save, and reload to verify persistence",
        surface: "inline slide-title edit, autosave, and reload persistence",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      },
      {
        test: "inline selection formatting stays in edit mode and survives history and reload",
        surface:
          "inline rich-text bold/link/font-size editing, history, and reload",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "inline list conversion and indentation stay editable through history and reload",
        surface: "inline list conversion, indent/outdent, history, and reload",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      },
      {
        test: "table cells and structure stay keyboard-editable through history and reload",
        surface:
          "slide-table cell keyboard editing, structure, history, and reload",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "authenticated user can open present mode",
        surface: "authenticated slide editor to present-mode navigation",
        viewport: "Desktop Chrome",
        auth: "seeded owner or optional external owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "export menu or dialog is reachable from the Slides editor",
        surface: "slide-editor export menu and format actions",
        viewport: "Desktop Chrome",
        auth: "seeded owner or optional external owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "unauthenticated access to /app redirects to login",
        surface: "unauthenticated application-route redirect",
        viewport: "Desktop Chrome",
        auth: "anonymous",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "unknown present link returns 404",
        surface: "unknown public present route privacy fallback",
        viewport: "Desktop Chrome",
        auth: "anonymous",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "app document editor route does not return a server error",
        surface: "unknown protected document route graceful response",
        viewport: "Desktop Chrome",
        auth: "anonymous",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "unknown /present/<slug>/embed path returns 404",
        surface: "unknown public present-embed route privacy fallback",
        viewport: "Desktop Chrome",
        auth: "anonymous",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "present-route 404 exposes root-layout language after navigation readiness",
        surface: "public present 404 document-language accessibility",
        viewport: "Desktop Chrome",
        auth: "anonymous",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "workspace page has a main landmark and a non-empty page title",
        surface: "authenticated workspace landmarks and document title",
        viewport: "Desktop Chrome",
        auth: "seeded owner or optional external owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "authenticated workspace exposes a visible create-document control",
        surface: "authenticated workspace create-document reachability",
        viewport: "Desktop Chrome",
        auth: "seeded owner or optional external owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      },
      {
        test: "presentation stage keyboard traversal, resize shortcuts, and live announcements are behavioral",
        surface:
          "stage traversal, duplication, resize shortcuts, and live announcements",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "slide editor toolbar controls are reachable by accessible role",
        surface: "slide-editor toolbar accessible control discovery",
        viewport: "Desktop Chrome",
        auth: "seeded owner or optional external owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      },
      {
        test: "add slide template picker traps focus and supports keyboard insertion",
        surface:
          "add-slide modal focus trap, dismissal, insertion, and restoration",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      },
      {
        test: "presentation visual picker modal traps focus and restores invoking focus",
        surface:
          "visual-picker modal focus trap, insertion, cancellation, and restoration",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
    ...
    tests: [
      {
        ...
        surface: "UI catalog totals, subsystem distribution, and unique IDs",
        viewport: "Playwright runner only",
        auth: "not applicable",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "required",
        status: "automated",
      },
      {
        ...
        surface: "automated-case source contract and reference integrity",
        viewport: "Playwright runner only",
        auth: "not applicable",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "required",
  ...
  },
  {
    ...
    tests: [
      {
        test: "owner configures, expires, protects, rotates, and disables a public share",
        surface: "public share page and asset lifecycle",
        viewport: "Desktop Chrome",
        auth: "seeded owner and anonymous public",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
