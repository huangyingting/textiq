...
export const UI_MATRIX_SPEC_INVENTORY = [
  ...
  },
  {
    ...
    coverage:
      "Shortcut and editor focus restoration, required-profile forced-colors stage focus visibility, plus mobile Edit/Add slide geometry, hit testing, and pointer activation.",
    runMode: "advisory-ci",
    prerequisites: ["E2E_PROFILE=1", "npm run db:seed:e2e"],
    roles: ["seeded owner"],
