...
export const UI_MATRIX_SPEC_INVENTORY = [
  ...
  },
  {
    ...
    tests: [
      {
        test: "authenticated present mode renders the seeded slide text @required-profile",
        surface: "authenticated present overlay render and asset loading",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "required",
      ...
      {
        test: "authenticated present mode exposes presenter controls and slide overview navigation",
        surface: "presenter progress, timer, notes, overview, and slide jump",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "authenticated present mode keeps HUD chrome outside mobile safe areas",
        surface: "authenticated present HUD safe-area geometry",
      ...
      {
        test: "public present mode renders the seeded deck via the share link @required-profile",
        surface: "public present route render and asset loading",
        viewport: "Desktop Chrome",
      ...
      {
        test: "public present mode keeps HUD chrome outside mobile safe areas",
        surface: "public present HUD safe-area geometry",
        viewport: "390x844 mobile",
        auth: "anonymous public",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "public present mode supports deterministic slide navigation",
        surface: "public next control, Home shortcut, progress, and URL hash",
        viewport: "Desktop Chrome",
        auth: "anonymous public",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "public presentation embed route renders chrome-free navigation",
        surface: "public presentation embed render and chrome suppression",
        viewport: "Desktop Chrome",
        auth: "anonymous public",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "public present mode supports keyboard ArrowRight and ArrowLeft navigation",
        surface: "public present bidirectional keyboard navigation",
        viewport: "Desktop Chrome",
        auth: "anonymous public",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "public present mode End key navigates to the last slide",
        surface: "public present End shortcut, progress, and URL hash",
        viewport: "Desktop Chrome",
        auth: "anonymous public",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "authenticated present mode closes overlay on Escape",
        surface: "authenticated present overlay keyboard dismissal",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "viewer user can open the public presentation link",
        surface: "authenticated viewer access to public present",
        viewport: "Desktop Chrome",
        auth: "seeded viewer",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "public present direct deep-link to slide 2 renders the second slide",
        surface: "public present direct slide hash deep link",
        viewport: "Desktop Chrome",
        auth: "anonymous public",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "public presentation embed mode Previous slide button returns to first slide",
        surface: "presentation embed deep link and previous navigation",
        viewport: "Desktop Chrome",
        auth: "anonymous public",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "exports a real PDF file with nonzero bytes @required-profile",
        surface: "authenticated document PDF download",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "required",
      ...
      {
        test: "exports real infographic PNG and PDF files at the selected widths",
        surface: "selected-width infographic PNG and PDF downloads",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "contains a browser rasterization failure and succeeds on retry",
        surface: "infographic raster failure alert and successful retry",
        viewport: "Desktop Chrome",
        auth: "seeded owner",
        profile: "normal deterministic profile (E2E_PROFILE=1)",
        ciTier: "advisory",
      ...
      {
        test: "a paid workspace editor exports the current document deck as PPTX",
        surface: "paid workspace-editor PPTX deck download",
        viewport: "Desktop Chrome",
