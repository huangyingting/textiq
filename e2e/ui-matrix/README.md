...
| `e2e/ui-matrix/account-lifecycle-ui.spec.ts`                    | auth, security, settings            | advisory-ci | `E2E_PROFILE=1`, `npm run db:seed:e2e`                                                              | anonymous, seeded owner, isolated account-mutation user | Desktop Chrome                                 | advisory deterministic E2E workflow        |
