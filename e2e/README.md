...
| `e2e/ui-matrix/*-ui.spec.ts`                            | Representative presentation/public/auth/editor/workspace checks; presentation and workspace/brand run in the deterministic profile |
...
`e2e/ui-matrix/presentation-ui.spec.ts`, and
