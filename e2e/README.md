...
| `e2e/presentation/presentation-controls.spec.ts`        | Arrange/group controls, precision guides, themes, ratio/master, and document-source history/persistence/public-render lifecycles |
